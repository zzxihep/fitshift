...
SWIGINTERN PyObject *_wrap_map_wave(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:map_wave",&obj0,&obj1)) SWIG_fail;
  {
    std::vector< double,std::allocator< double > > *ptr = (std::vector< double,std::allocator< double > > *)0;
    res1 = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_gauss_filter(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:gauss_filter",&obj0,&obj1,&obj2)) SWIG_fail;
  {
    std::vector< double,std::allocator< double > > *ptr = (std::vector< double,std::allocator< double > > *)0;
    res1 = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"map_wave", _wrap_map_wave, METH_VARARGS, NULL},
	 { (char *)"gauss_filter", _wrap_gauss_filter, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
