...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_convol', [dirname(__file__)])
        except ImportError:
            import _convol
            return _convol
        if fp is not None:
            try:
                _mod = imp.load_module('_convol', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _convol = swig_import_helper()
...
class SwigPyIterator(_object):
    ...
    def __iter__(self):
        return self
SwigPyIterator_swigregister = _convol.SwigPyIterator_swigregister
...
class DoubleVector(_object):
    ...
    def __init__(self, *args):
        this = _convol.new_DoubleVector(*args)
        try:
    ...
    __del__ = lambda self: None
DoubleVector_swigregister = _convol.DoubleVector_swigregister
