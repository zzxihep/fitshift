...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_rebin', [dirname(__file__)])
        except ImportError:
            import _rebin
            return _rebin
        if fp is not None:
            try:
                _mod = imp.load_module('_rebin', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _rebin = swig_import_helper()
...
class SwigPyIterator(_object):
    ...
    def __iter__(self):
        return self
SwigPyIterator_swigregister = _rebin.SwigPyIterator_swigregister
...
class DoubleVector(_object):
    ...
    def __init__(self, *args):
        this = _rebin.new_DoubleVector(*args)
        try:
    ...
    __del__ = lambda self: None
DoubleVector_swigregister = _rebin.DoubleVector_swigregister
